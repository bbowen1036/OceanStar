...
product14 = Product.create!( name: "Uni Tray (A Grade)- 200g", price: "80", description: "Pacific West Coast A grade Uni - Sourced from various locations between Alaska, Ft. Bragg, Santa Barbara, Baja", category_id: "4")
